...
from settings import SCREEN as DIMENSION_PANTALLA, BACKGROUND, THISORTHAT
...
class MainMenu(Menu):
    ...
    def __init__(self, name, pantalla, x, y, active, level_num, music_path):
        ...
        self.surface = pg.image.load(BACKGROUND).convert_alpha()
        ...
        self.logo = Logo(x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2-300,texto="", pantalla=pantalla, font_size=1)
        ...
        self.button_start = Button(x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2, texto='COMENZAR', pantalla=pantalla, on_click=self.click_start, on_click_param='form_game')
