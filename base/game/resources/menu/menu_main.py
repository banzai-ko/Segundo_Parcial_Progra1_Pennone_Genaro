...
class MainMenu(Menu):
    ...
    def __init__(self, name, pantalla, x, y, active, level_num, music_path):
        ...
        self.logo = Logo(x=(DIMENSION_PANTALLA[0]) // 2,
        ...
        self.menu_ppal_subtitle = TextTitle(
            x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2-150, texto='MENU PRINCIPAL', pantalla=pantalla, font_size=50)

        self.button_start = Button(x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2,
                                   texto='COMENZAR', pantalla=pantalla, on_click=self.click_start, on_click_param='form_game')
        ...
        self.button_options = Button(x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2+75,
                                     texto='OPCIONES', pantalla=pantalla, on_click=self.click_option, on_click_param='form_options')
        self.button_rankings = Button(x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2+150,
                                      texto='RANKING', pantalla=pantalla, on_click=self.click_ranking, on_click_param='form_rankings')
        self.button_exit = Button(
            x=DIMENSION_PANTALLA[0]//2, y=DIMENSION_PANTALLA[1]//2+225, texto='EXIT', pantalla=pantalla, on_click=self.click_exit)

        self.widget_list = [
            self.menu_ppal_subtitle, self.button_exit,  # self.button_level_select,
