...
class MenuManager:
    ...
    def __init__(self, pantalla, ranking_db = None):
        ...
        self.forms = [
            MainMenu(name='form_main_menu', pantalla=self.main_screen, x=0, y=0, active=True, level_num=1, music_path=SONIDO_MENU),
            MenuRanking(name='form_rankings', pantalla=self.main_screen, x=0, y=0, active=True, level_num=1, music_path=SONIDO_RANKING, ranking_list=self.ranking_db),
            MenuOptions(name='form_options', pantalla=self.main_screen, x=0, y=0, active=True, level_num=1, music_path=SONIDO_OPCIONES),
            MenuPause(name="form_pause",pantalla=self.main_screen,x=0,y=0,active=True,level_num=self.current_level,music_name=SONIDO_MUSIC),
            MenuEnterName(name="form_enter_name",pantalla=self.main_screen,x=0,y=0,active=True,level_num=1,music_name=SONIDO_MENU,score=0),
            MenuGame(name="form_game",pantalla=self.main_screen,x=0,y=0,active=True,level_num=1,music_path=SONIDO_MENU)
